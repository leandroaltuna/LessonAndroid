package com.example.fourthlesson.app.list;
...
import com.example.fourthlesson.app.R;
import com.example.fourthlesson.app.models.Tweet;
import com.example.fourthlesson.app.utils.BitmapManager;
...
public class TweetAdapter extends ArrayAdapter<Tweet> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        onlyHolder.createdAt.setText(tweets.get(position).getCreatedAt());
